...
# main config
PLUGINSLUG="wp-force-http"
CURRENTDIR=`pwd`
MAINFILE="wordpress-force-http.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/wp-force-http/" # Remote SVN repo on wordpress.org, with no trailing slash
